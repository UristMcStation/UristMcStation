//moving this here to avoid compile issues on other maps
/datum/map/nerva
	objective_items = list(
		"the captain's antique revolver" = /obj/item/gun/projectile/revolver/coltsaa,
		...
		"the ICS Nerva blueprints" = /obj/item/blueprints,
