...
/datum/job/chief_engineer
	...
	department_flag = ENG
	outfit_type = /singleton/hierarchy/outfit/job/bearcat/chief_engineer

/datum/job/doctor
	title = "Doc"
	supervisors = "the Captain and your idea of Hippocratic Oath"
	outfit_type = /singleton/hierarchy/outfit/job/bearcat/doc
	alt_titles = list(
		"Surgeon")
	total_positions = 1
	spawn_positions = 1
...
/datum/job/hop
	...
	outfit_type = /singleton/hierarchy/outfit/job/bearcat/mate
	hud_icon = "hudheadofpersonnel"

/datum/job/assistant
	title = "Deck Hand"
	supervisors = "literally everyone, you bottom feeder"
	outfit_type = /singleton/hierarchy/outfit/job/bearcat/hand
	alt_titles = list(
		"Cook" = /singleton/hierarchy/outfit/job/bearcat/hand/cook,
		"Cargo Hand",
		"Passenger")
...
/datum/job/cyborg
	...
	outfit_type = /singleton/hierarchy/outfit/job/bearcat/hand/engine
	total_positions = 1
	spawn_positions = 1
...
/singleton/hierarchy/outfit/job/bearcat/chief_engineer
...
/singleton/hierarchy/outfit/job/bearcat/doc
...
/singleton/hierarchy/outfit/job/bearcat/mate
...
/singleton/hierarchy/outfit/job/bearcat/hand/pre_equip(mob/living/carbon/human/H)
	..()
...
/singleton/hierarchy/outfit/job/bearcat/hand/cook
	name = BEARCAT_OUTFIT_JOB_NAME("Cook")
	head = /obj/item/clothing/head/chefhat
	suit = /obj/item/clothing/suit/chef/classic

/singleton/hierarchy/outfit/job/bearcat/hand/engine
	name = BEARCAT_OUTFIT_JOB_NAME("Junior Engineer")
	head = /obj/item/clothing/head/hardhat
	flags = OUTFIT_HAS_BACKPACK|OUTFIT_EXTENDED_SURVIVAL

/singleton/hierarchy/outfit/job/bearcat/hand/engine/pre_equip(mob/living/carbon/human/H)
	..()
	if(prob(50))
		suit = /obj/item/clothing/suit/storage/hazardvest
