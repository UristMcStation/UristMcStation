/decl/cultural_info/culture/hidden/xenophage/lactera
	...
	effectively with the other members of their hivemind."
...
/decl/cultural_info/faction/galactic_crisis
	...
	by the psyionic control of the Allophylus, the only goal of the alien forces appears to be to wipe out humanity and to mind-slave them to the Allyphylus, as has been done \
