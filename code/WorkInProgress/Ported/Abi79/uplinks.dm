...
/*
					...
					if(hasRevolver) randomItems.Add("/obj/item/ammo_box/a357") //Revolver ammo
*/
					randomItems.Add("/obj/item/ammo_box/a357") //Revolver ammo
				...
				if(!randomItems)
					...
					switch(href_list["buy_item"]) //Ok, this gets a little messy, sorry.
						...
						"/obj/item/weapon/storage/syndie_kit/imp_freedom" , "/obj/item/clothing/glasses/thermal")
							uses -= 3
						if("/obj/item/ammo_box/a357" , "/obj/item/clothing/shoes/syndigaloshes" , "/obj/item/weapon/plastique")
							uses -= 2
