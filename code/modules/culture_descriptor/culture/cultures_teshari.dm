/decl/cultural_info/culture/teshari
	...
	complementary mindsets. Teshari never developed space flight themselves, but due to their small size and good dark vision \
	the	Skrell brought them aboard their ships to serve as engineers for the cramped maintenance tunnels of \
	their vessels. In modern times Tesharii can be seen serving as anything from simple engineers to \
