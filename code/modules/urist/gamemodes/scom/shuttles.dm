...
/datum/shuttle/ferry/scom
	var/missiontime = 10 //3000 //5 minutes. I gotta do some real testing in a full round to figure out if we're going to have 10 hour scom rounds or some bullshit like that.
	var/mission = 0
