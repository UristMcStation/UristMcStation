...
/obj/effect/overmap/sector/destroyed_colony
	...
	desc = "A former Terran Confederation colony, any settlements made on this world were destroyed during the Galactic Crisis. Little remains, but we are detecting a faint signal from a destroyed settlement."
	icon_state = "globe"
	known = 0
	in_space = 0
...
/obj/effect/shuttle_landmark/nav_destroyed_colony/nav1
	...
	base_area = /area/jungle/destroyed_colony
	base_turf = /turf/simulated/floor/planet/ariddirt/clear
