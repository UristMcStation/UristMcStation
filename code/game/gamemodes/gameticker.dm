...
//				LoadScom()
				world << "\red \b Welcome to the first version of S-COM. Remember to set up your character properly: Captains become commanders, scientists and the RD become researchers, all other heads become squad leaders and everyone else becomes soldiers to choose their class ingame. <BR><BR> As this is the first version, expect balance to be a little wonky, weird AI behaviour (I'm still working on it, it'll be better for the next open test) and expect bugs. I'm counting on you to report bugs and balance issues either on github, the forums or the B12 thread.<BR><BR> Coming in the next update: More missions, more enemies and improved enemy behaviour, bugfixes, more stuff for science to science (and expanded science in general), expanded failure states and the return of friendly NPCs (disabled for the first version because of runtimes). The plan is to do at least 1 more test like this before it becomes a regular votable gamemode in a week."
