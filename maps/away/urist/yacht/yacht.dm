...
/obj/overmap/visitable/ship/yacht
	name = "private yacht"
	desc = "Sensor array is detecting a small vessel with various unknown lifeforms on board."
	color = "#ffc966"
	vessel_mass = 3000
...
/datum/map_template/ruin/away_site/yacht
	name = "Yacht"
	id = "awaysite_yach"
	description = "Tiny movable ship with various lifeforms."
	suffixes = list("urist/yacht/yacht.dmm")
	spawn_cost = 0.5
	area_usage_test_exempted_root_areas = list(/area/yacht)
	template_flags = TEMPLATE_FLAG_SPAWN_GUARANTEED // For TESTING!!!!!!!!!!!!!!
