/datum/job
	...
	var/skill_points = 0				  //The number of unassigned skill points the job comes with (on top of the minimum skills).
...
/datum/job/proc/setup_account(mob/living/carbon/human/H)
	...
	var/money_amount = rand(70, 110) * rand(3,5) * economic_power
