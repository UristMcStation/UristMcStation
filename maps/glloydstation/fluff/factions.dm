...
/singleton/cultural_info/faction/remote/nanotrasen
	...
	- a distressing rival to some minor star systems. In charge of everything is NanoTrasen's powerful administrative branch, which directs their company's actions. \
