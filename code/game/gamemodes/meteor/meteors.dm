...
/obj/meteor/supermatter/missile/sabot_round //why is this a child of supermatter meteors when it inherits nothing from its parent. bay is so fucking stupid it makes my head hurt.
	name = "Sabot Round"
