...
/obj/item/clothing/suit/storage/hazardvest/New()
	..()
	pockets = new/obj/item/weapon/storage/internal(src)
	pockets.storage_slots = 2	//two slots
	pockets.max_w_class = 1		//fit only pocket sized items
