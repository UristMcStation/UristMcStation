...
#define IC_ACTION_MOVEMENT		FLAG_01 // If the circuit can move the assembly
#define IC_ACTION_COMBAT		FLAG_02 // If the circuit can cause harm
#define IC_ACTION_LONG_RANGE	FLAG_03 // If the circuit communicate with something outside of the assembly
