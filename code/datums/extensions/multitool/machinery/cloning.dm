/*/datum/extension/interactive/multitool/cryo/get_interact_window(obj/item/device/multitool/M, var/mob/user)
	. += buffer(M)
...
/datum/extension/interactive/multitool/cryo/receive_buffer(obj/item/device/multitool/M, var/atom/buffer, var/mob/user)
