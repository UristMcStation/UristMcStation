/obj/item/shellfish
	...
	var/snack_path = /obj/item/weapon/reagent_containers/food/snacks/shellfish
...
/obj/item/shellfish/clam
	...
	icon_state = "clam"
	snack_path = /obj/item/weapon/reagent_containers/food/snacks/shellfish/clam

/obj/item/shellfish/mussel
	name = "mussel"
	desc = "A fresh mussel. Needs to be cracked open before eating."
	icon_state = "mussel"
	snack_path = /obj/item/weapon/reagent_containers/food/snacks/shellfish/mussel

/obj/item/shellfish/oyster
	name = "oyster"
	desc = "A fresh oyster. Needs to be cracked open before eating."
	icon_state = "oyster"
	snack_path = /obj/item/weapon/reagent_containers/food/snacks/shellfish/oyster

/obj/item/shellfish/shrimp
	name = "shrimp"
	desc = "A fresh shrimp. Needs to be cracked open before eating."
	icon_state = "shrimp"
	snack_path = /obj/item/weapon/reagent_containers/food/snacks/shellfish/shrimp

/obj/item/shellfish/crab
	name = "crab"
	desc = "A fresh crab. Mind the pincers."
	icon_state = "crab"
	snack_path = /obj/item/weapon/reagent_containers/food/snacks/shellfish/crab


//edible
/obj/item/weapon/reagent_containers/food/snacks/shellfish
	name = "raw shellfish"
	desc = "You shouldn't be seeing this."
	icon = 'icons/obj/food_shellfish.dmi'
...
/obj/item/weapon/reagent_containers/food/snacks/shellfish/clam/Initialize()
	.=..()
...
/obj/item/weapon/reagent_containers/food/snacks/shellfish/mussel/Initialize()
	.=..()
...
/obj/item/weapon/reagent_containers/food/snacks/shellfish/oyster/Initialize()
	.=..()
...
/obj/item/weapon/reagent_containers/food/snacks/shellfish/shrimp/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 3)
...
/obj/item/weapon/reagent_containers/food/snacks/shellfish/crab
	...
	bitesize = 3
/obj/item/weapon/reagent_containers/food/snacks/shellfish/crab/Initialize()
	.=..()
