...
/datum/away_mission/miningcluster
	map_path = "maps/RandomZlevels/mining/mining-asteroid.dmm"
	value = 15
	random_start = TRUE

/datum/away_mission/miningcluster/perform_setup()
...
/datum/away_mission/miningsignal
	map_path = "maps/RandomZlevels/mining/mining-signal.dmm"
	value = 20
	random_start = TRUE

/datum/away_mission/miningsignal/perform_setup()
	new /datum/random_map/automata/cave_system(null, 1, 1, world.maxz, 200, 200)
	new /datum/random_map/noise/ore(null, 1, 1, world.maxz, 200, 200)
