...
/obj/overmap/visitable/ship/wyrm
	name = "ISC Wyrm"
	vessel_mass = 150
	fore_dir = WEST
...
/obj/shuttle_landmark/pod/docked
	name = "Docking Port"
	landmark_tag = "nav_docked_pod"

/obj/shuttle_landmark/wyrm/docked/hatchling
	name = "Docking Port"
	landmark_tag = "wyrm_docked_hatchling"
	docking_controller = "wyrm_docking_hatch"

/obj/shuttle_landmark/wyrm/docked/rescue
	name = "Docking Port"
	landmark_tag = "wyrm_docked_rescue"

/obj/shuttle_landmark/pod/transit
	name = "In transit"
	landmark_tag = "nav_transit_pod"

/obj/shuttle_landmark/wyrm/transit/hatchling
	name = "In transit"
	landmark_tag = "nav_transit_hatchling"

/obj/shuttle_landmark/wyrm/transit/lanius
	name = "In transit"
	landmark_tag = "nav_transit_lanius"

/obj/shuttle_landmark/wyrm/transit/rescue
	name = "In transit"
	landmark_tag = "nav_transit_rescue"

/obj/shuttle_landmark/pod/escaped
	name = "Escaped"
	landmark_tag = "nav_escaped_pod"

// completely 'normal' mining away

/obj/overmap/visitable/cluster
...
/obj/shuttle_landmark/away/pod
	name = "Asteroid Navpoint #1"
	landmark_tag = "nav_cluster_1"

/obj/overmap/visitable/random
...
/obj/shuttle_landmark/refueling
	name = "Docking Bay"
	landmark_tag = "docking_bay"
	base_area = /area/away/refueling
	base_turf = /turf/simulated/floor/plating

/obj/overmap/visitable/refueling
