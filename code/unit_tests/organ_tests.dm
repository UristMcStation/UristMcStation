...
/datum/unit_test/species_organ_creation/proc/check_internal_organs(mob/living/carbon/human/H, singleton/species/species)
	. = 1
...
/datum/unit_test/species_organ_creation/proc/check_external_organs(mob/living/carbon/human/H, singleton/species/species)
	. = 1
...
/datum/unit_test/species_organ_creation/proc/check_organ_parents(mob/living/carbon/human/H, singleton/species/species)
	. = 1
...
/datum/unit_test/species_organ_creation/start_test()
	var/failcount = 0
	for(var/singleton/species/species in GLOB.species_by_name)
