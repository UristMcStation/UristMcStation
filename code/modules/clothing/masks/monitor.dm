...
/obj/item/clothing/mask/monitor
	...
	var/static/list/monitor_states = list(
		...
		"eye" =     "ipc_eye",
		"eyes" =     "ipc_eyes",
		"color_array" =     "ipc_color_array",
		"array_horizontal" =     "ipc_color_array_horizontal",
		"array_vertical" =     "ipc_color_array_vertical",
		"television" =     "ipc_television",
		"miami" =     "ipc_miami",
		"waiting" =     "ipc_waiting",
		"smoking" =     "ipc_smoking",
		"visor" =		 "ipc_visor",
