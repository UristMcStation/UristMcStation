...
/decl/cultural_info/culture/human/martian_tunneller
	...
	and wary of outsiders, and tend to strongly dislike non-Martians. Much of the UHA support on Mars comes from Tunnellers."
...
/decl/cultural_info/culture/human/orma
	...
	you are used to hardships. Indeed, ORMA outposts have long been a target for pirates, and ORMA was the first to be hit by the alien invasion during the Galactic Crisis. \
	In fact, ORMA has only recently been reestablished, and many have yet to return to the ruins of their homes. People from ORMA are typically raised in small, confined environments with few others, and tend to be most familiar with older, reliable but outdated \
...
/decl/cultural_info/culture/human/graveworlder
	...
	hoping to return to a home that no longer exists. Those displaced by the Galacitic Crisis are derisively referred to as 'Graveworlders' by those lucky enough to \
