...
/proc/generate_titles()
	...
	if(!GLOB.end_credits_title)
		...
		possible_titles += "THE [pick("DOWNFALL OF ", "RISE OF ", "TROUBLE WITH ", "FINAL STAND OF ", "DARK SIDE OF ", "THE LACK OF ", "DESOLATION OF ", "DESTRUCTION OF ", "THE ISSUE WITH ", "CRISIS OF ")]\
							...
							"THE SUPERMATTER CRYSTAL", "MEDICAL", "ENGINEERING", "SECURITY", "RESEARCH", "THAT ONE LAST CREWMATE", "THE SERVICE DEPARTMENT", "COMMAND", "THE EXPLORERS", "THE AWAY TEAM", "THE BOTANIST", "THE CHEF", "BREATHABLE AIR", "THE KITCHEN", "THE BAR", "THE BARTENDER", "[uppertext(GLOB.using_map.station_name)]")]"
		...
		possible_titles += "THE CREW LEARNS ABOUT [pick("LOVE", "DRUGS", "THE DANGERS OF MONEY LAUNDERING", "THE FASHION POLICE", "XENIC SENSITIVITY", "PIRATES, PIRATES, PIRATES!", "DISPOSAL CHUTES", "SUIT SENSORS", "GET RICH QUICK SCHEMES", "HEALTH INSURANCE", "INVESTMENT FRAUD", "KELOTANE ABUSE", "HYPERZINE SNORTING", "COMBINING WATER AND POTASSIUM", "RADIATION PROTECTION", "SACRED GEOMETRY", "STRING THEORY", "ABSTRACT MATHEMATICS",\
							"[pick("UNATHI", "SKRELLIAN", "DIONAN", "RESOMI", "VOX", "IPC")] MATING RITUALS", "ANCIENT CHINESE MEDICINE", "THE IMPORTANCE OF [pick("AIRLOCK SAFETY", "MAINTENANCE", "SUIT SENSORS", "FLOOR PILLS", "ELEVATORS", "HEIGHTS", "TORPEDOS", "GOOD RELATIONS", "A FULLY STOCKED BAR", "AWAY MISSIONS", "MANDATORY DRUG TESTING", "HIRING SECURITY", "GOOD FORENSICS", "TEST WIRES", "UNIONS", "NEURAL LACES", "ENGINEERS")]")]"
		possible_titles += "A VERY [pick("CORPORATE", "NANOTRASEN", "FLEET", "TERRAN", "LACTERAN", "HAPHAESTUS", "DAIS", "XENOLIFE", "EXPEDITIONARY", "DIONAN", "PHORON", "MARTIAN", "RESOMI")] [pick("CHRISTMAS", "EASTER", "HOLIDAY", "WEEKEND", "THURSDAY", "VACATION", "FRIDAY", "MONDAY", "NEW YEARS", "BOXING DAY")]"
		possible_titles += "[pick("GUNS, GUNS EVERYWHERE", "THE LITTLEST ARMALIS", "WHAT HAPPENS WHEN YOU MIX MAINTENANCE DRONES AND COMMERCIAL-GRADE PACKING FOAM", "INTERNALLY COHERANT, HARDCORE CRAZY TO THE MEGA", "ATTACK! ATTACK! ATTACK!", "SEX BOMB", "THE LEGEND OF THE ALIEN ARTIFACT: PART [pick("I","II","III","IV","V","VI","VII","VIII","IX", "X", "C","M","L")]")]"
		...
		possible_titles += "THE CREW [pick("FALL OUT A AIRLOCK", "LOOKS UP", "FUCKING DIES", "DESTROY THE [uppertext(GLOB.using_map.station_short)]", "DON'T DO ANYTHING", "GOES TO HELL", "GOES TO SPACE PRISON", "EATS PACKING PEANUTS", "FORGET HOW TO BE KIND",  "MOVE TO A EXOPLANET", "CATCH A STOWAWAY", "FALL OUT A WINDOW", "SETTLE A LAWSUIT", "BUY A NEW SHIP", "FIND A DEAD GUY", "LOVES [pick("MEDBAY", "ALCOHOL", "YOU", "UNREGISTERED GUNS", "MONKEY CUBES", "MAKING A MESS", "ANNOYING COMMAND", "GETTING BRIGGED")]")]"
