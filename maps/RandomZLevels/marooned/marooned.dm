...
/datum/away_mission/marooned
	map_path = "maps/RandomZlevels/marooned/marooned.dmm"
	value = 20
	random_start = TRUE

/datum/away_mission/marooned/perform_setup()
	new /datum/random_map/automata/cave_system(null, 2, 2, world.maxz, 99, 99)
	new /datum/random_map/noise/ore(null, 2, 2, world.maxz, 99, 99)
