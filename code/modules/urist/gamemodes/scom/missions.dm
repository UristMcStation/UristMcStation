...
/datum/scommissions/m1
	mission = 1
	missionannounce = "Alien forces have hit a Nanotrasen transit facility in the Nyx sector. Get out there fast, there might still be some civilians left alive out there."
	missionloc1 = /area/shuttle/scom/s1/mission1
	missionloc2 = /area/shuttle/scom/s2/mission1

/datum/scommissions/m2
	mission = 2
	missionannounce = "All S-COM forces, respond immediately! S-COM research facility X7A is under attack! Requesting immediate assistance! Be careful with your shots though, you may expose the area to space!"
...
/datum/scommissions/m5
	mission = 5
	missionannounce = "Tau Ceti has mostly fallen, but we're still getting reports about survivors. Most recently we recieved signals from the Nanotrasen outpost on Luthien IV. Get out there and see what the hell's going on."
...
/datum/scommissions/m7
	mission = 7
	missionannounce = "We're in luck soldiers. We've managed to shoot down two alien craft over a jungle planet located in the Nyx system. Bad news is that it's on the side of the planet in perpetual darkness. We need to salvage what we can from their ships, so we're sending you out anyways. Good luck."
	missionloc1 = /area/shuttle/scom/s1/mission7
	missionloc2 = /area/shuttle/scom/s2/mission7

/datum/scommissions/m8
	mission = 8
	...
	missionloc1 = /area/shuttle/scom/s1/mission8
	missionloc2 = /area/shuttle/scom/s2/mission8

/datum/scommissions/m9
	mission = 9
	...
	missionloc1 = /area/shuttle/scom/s1/mission9
	missionloc2 = /area/shuttle/scom/s2/mission9

/datum/scommissions/m10
	mission = 10
	...
	missionloc1 = /area/shuttle/scom/s1/mission10
	missionloc2 = /area/shuttle/scom/s2/mission10
