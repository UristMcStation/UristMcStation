...
/datum/map_template/ruin/away_site/chemical_lab
	...
	suffixes = list("chemical_lab/chemical_lab-1.dmm", "chemical_lab/chemical_lab-2.dmm")  // Only took me 3 fucking hours to figure out I need to use a map-data landmark to make this fucker spawn...
	spawn_cost = 1
	player_cost = 0
	template_flags = TEMPLATE_FLAG_SPAWN_GUARANTEED

/obj/effect/overmap/visitable/sector/chemical_lab
	name = "Scrambled Signal"
...
/obj/effect/submap_landmark/joinable_submap/chemical_lab
	...
	archetype = /singleton/submap_archetype/derelict/chemical_lab

/singleton/submap_archetype/derelict/chemical_lab
	descriptor = "Scrambled Signal"
	map = "chemical_lab"
	crew_jobs = list(
			/datum/job/submap/lab_supervisor,
			/datum/job/submap/lab_worker
	)
...
/obj/item/folder/envelope/urist/supervisor_instructions
...
/obj/item/folder/envelope/urist/supervisor_instructions/Initialize()
	. = ..()
