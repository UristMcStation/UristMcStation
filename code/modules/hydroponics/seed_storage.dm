...
/obj/machinery/seed_storage/garden
	...
	starting_seeds = list(
		...
		/obj/item/seeds/pearseed = 30,
		/obj/item/seeds/peppercornseed = 30,
		/obj/item/seeds/pineappleseed = 30,
