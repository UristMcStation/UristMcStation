/mob/living/simple_animal/passive/npc/proc/player_sell(var/obj/O, var/mob/M, var/resell = 1)
	if(no_resell)
		resell = 0
...
/mob/living/simple_animal/passive/npc/proc/try_list_for_sale(var/obj/O)
	var/datum/trade_item/T = trade_items_inventory_by_type[O.type]
	if(T)
		T.quantity += 1
...
/mob/living/simple_animal/passive/npc/proc/player_buy(var/item_name, var/mob/M)
...
/mob/living/simple_animal/passive/npc/proc/GiveItem(var/datum/trade_item/D, var/mob/M)
...
/mob/living/simple_animal/passive/npc/proc/GiveFreeItem(var/datum/trade_item/D, var/mob/M)
	var/obj/O = new D.item_type(M.loc)
	M.put_in_hands(O)
...
/mob/living/simple_animal/passive/npc/proc/CanPurchase(var/mob/M, var/access)
