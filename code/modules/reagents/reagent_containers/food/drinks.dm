...
/obj/item/weapon/reagent_containers/food/drinks
	...
	volume = 50
	var/drink_sounds = list("sound/urist/drink1.ogg, sound/urist/drink2.ogg, sound/urist/drink3.ogg, sound/urist/drink4.ogg")
...
/obj/item/weapon/reagent_containers/food/drinks/feed_sound(var/mob/user)
	playsound(user.loc, pick(drink_sounds), rand(10, 50), 1)
