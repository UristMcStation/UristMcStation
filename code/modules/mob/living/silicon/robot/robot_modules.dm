...
/obj/item/weapon/robot_module/standard
	...
	sprites = list(	"Basic" = "robot_old",
					...
					"Advanced Drone" = "pear120-Standard",
					"Wiredroid" = "pandarsenic-Standard",
					"Worm" = "donofnyc3-Standard",
					"Spider" = "mechoid-Standard",
					"Eyebot" = "matthew951-standard"
				  )
...
/obj/item/weapon/robot_module/medical/surgeon
	...
	sprites = list(
					...
					"Advanced Drone" = "pear120-Medical",
					"Wiredroid" = "pandarsenic-Medical",
					"Worm" = "donofnyc3-Surgeon",
					"Spider" = "mechoid-Surgeon",
					"Eyebot" = "matthew951-surgeon"
					)
...
/obj/item/weapon/robot_module/medical/crisis
	...
	sprites = list(
					...
					"Advanced Drone" = "pear120-Medical",
					"Wiredroid" = "pandarsenic-Medical",
					"Worm" = "donofnyc3-Crisis",
					"Spider" = "mechoid-Crisis",
					"Eyebot" = "matthew951-crisis"
					)
...
/obj/item/weapon/robot_module/engineering
	...
	sprites = list(
					...
					"Advanced Drone" = "pear120-Engineering",
					"Wiredroid" = "pandarsenic-Engineering",
					"Worm" = "donofnyc3-Engineering",
					"Spider" = "mechoid-Engineering",
					"Eyebot" = "matthew951-engineering"
					)
...
/obj/item/weapon/robot_module/security/general
	sprites = list(
					...
					"Advanced Drone" = "pear120-Security",
					"Wiredroid" = "pandarsenic-Security",
					"Worm" = "donofnyc3-Security",
					"Spider" = "mechoid-Security",
					"Eyebot" = "matthew951-security"
				)
...
/obj/item/weapon/robot_module/janitor
	...
	sprites = list(
					...
					"Advanced Drone" = "pear120-Janitor",
					"Wiredroid" = "pandarsenic-Janitor",
					"Worm" = "donofnyc3-Janitor",
					"Spider" = "mechoid-Janitor",
					"Eyebot" = "matthew951-janitor"
					)
...
/obj/item/weapon/robot_module/clerical/butler
	sprites = list(	"Waitress" = "Service",
					...
					"Advanced Drone" = "pear120-Service",
					"Wiredroid" = "pandarsenic-Service",
					"Worm" = "donofnyc3-Service",
					"Spider" = "mechoid-Clerical",
					"Eyebot" = "matthew951-service"
				  	)
...
/obj/item/weapon/robot_module/miner
	...
	sprites = list(
					...
					"Advanced Drone" = "pear120-Miner",
					"Wiredroid" = "pandarsenic-Miner",
					"Worm" = "donofnyc3-Miner",
					"Spider" = "mechoid-Miner",
					"Eyebot" = "matthew951-miner"
				)
...
/obj/item/weapon/robot_module/research
	...
	sprites = list(
					"Droid" = "droid-science",
					"Drone" = "drone-science",
					"Advanced Drone" = "pear120-Research",
					"Wiredroid" = "pandarsenic-Medical",
					"Worm" = "donofnyc3-Crisis",
					"Spider" = "mechoid-Surgeon"
					)
