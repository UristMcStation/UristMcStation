...
/mob/living/carbon/human/attack_generic(var/mob/user, var/damage, var/attack_message, var/damage_type = BRUTE)
	...
	var/armor_block = run_armor_check(affecting, "melee")
	apply_damage(damage, damage_type, affecting, armor_block)
	updatehealth()
	return 1
