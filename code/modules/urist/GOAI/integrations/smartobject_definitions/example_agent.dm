...
GOAI_ACTIONSET_FROM_FILE_BOILERPLATE(/mob/living/simple_animal/hostile, "code/modules/urist/GOAI/goai_data/smartobject_definitions/simplemob_agent.json")
GOAI_HAS_UTILITY_ACTIONS_BOILERPLATE_ISPAWN(/mob/living/simple_animal/hostile)

/* Real human bean */
GOAI_ACTIONSET_FROM_FILE_BOILERPLATE(/mob/living/carbon/human, "code/modules/urist/GOAI/goai_data/smartobject_definitions/humanoid_agent.json")
