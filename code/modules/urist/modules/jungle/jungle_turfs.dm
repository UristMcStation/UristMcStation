...
/turf/simulated/floor/plating/planet/update_air_properties() //No, you can't flood the jungle with phoron silly.
	return

/turf/simulated/floor/plating/planet/Initialize()
	if(icon_spawn_state)
...
/turf/simulated/floor/plating/planet/ex_act(severity)
	return

/turf/simulated/floor/plating/planet/border
	density = 1
	opacity = 1
...
/turf/simulated/floor/plating/planet/border/Bumped(M as mob)
...
/turf/simulated/floor/plating/planet/attackby(var/obj/item/I as obj, mob/user as mob)
...
/turf/simulated/floor/plating/planet/jungle
...
/turf/simulated/floor/plating/planet/jungle/med
...
/turf/simulated/floor/plating/planet/jungle/thick
...
/turf/simulated/floor/plating/planet/jungle/templatethick //for templates so trees and stuff don't get deleted.
...
/turf/simulated/floor/plating/planet/jungle/clear
...
/turf/simulated/floor/plating/planet/jungle/clear/grass1
	bushspawnchance = 0
	plants_spawn_chance = 0
	small_trees_chance = 0
...
/turf/simulated/floor/plating/planet/jungle/clear/dark
	icon_state = "grass1" //clear
//	icon_spawn_state = "grass1"
	luminosity = 0
	icon_spawn_state = null

/turf/simulated/floor/plating/planet/jungle/path
	bushspawnchance = 0
	small_trees_chance = 0
	name = "wet grass"
	desc = "thick, long wet grass"
...
/turf/simulated/floor/plating/planet/jungle/proc/Spread(var/probability, var/prob_loss = 50)
	if(probability <= 0)
		return

	//world << "<span class='notice'> Spread([probability])</span>"
	for(var/turf/simulated/floor/plating/planet/jungle/J in orange(1, src))
		if(!J.bushspawnchance)
			continue

		var/turf/simulated/floor/plating/planet/jungle/P = null
		if(J.type == src.type)
			P = J
		else
			P = new src.type(J)
...
/turf/simulated/floor/plating/planet/jungle/plains
	bushspawnchance = 0
	small_trees_chance = 0
...
/turf/simulated/floor/plating/planet/jungle/plains/Initialize()
	if(prob(4))
...
/turf/simulated/floor/plating/planet/jungle/clear/plains
	icon = 'icons/urist/events/train.dmi'
	icon_state = "g"
	icon_spawn_state = "g"
	animal_spawn_chance = 0
...
/turf/simulated/floor/plating/planet/jungle/impenetrable
...
/turf/simulated/floor/plating/planet/jungle/impenetrable/Initialize()
	var/obj/structure/bush/B = new(src)
	B.indestructable = 1
	. = ..()

//copy paste from asteroid mineral turfs
/turf/simulated/floor/plating/planet/jungle/rock
	bushspawnchance = 0
	small_trees_chance = 0
	plants_spawn_chance = 0
	animal_spawn_chance = 0
...
//Rocks fall, you die
/turf/simulated/floor/plating/planet/jungle/rock/attackby(obj/item/weapon/W as obj, mob/user as mob)
...
/turf/simulated/floor/plating/planet/jungle/rock/Initialize()
	var/turf/T
	if(!istype(get_step(src, NORTH), /turf/simulated/floor/plating/planet/jungle/rock) && !istype(get_step(src, NORTH), /turf/unsimulated/wall))
		T = get_step(src, NORTH)
		if (T)
			T.overlays += image('icons/urist/turf/uristturf.dmi', "rock_side_s")
	if(!istype(get_step(src, SOUTH), /turf/simulated/floor/plating/planet/jungle/rock) && !istype(get_step(src, SOUTH), /turf/unsimulated/wall))
		T = get_step(src, SOUTH)
		if (T)
			T.overlays += image('icons/urist/turf/uristturf.dmi', "rock_side_n", layer=6)
	if(!istype(get_step(src, EAST), /turf/simulated/floor/plating/planet/jungle/rock) && !istype(get_step(src, EAST), /turf/unsimulated/wall))
		T = get_step(src, EAST)
		if (T)
			T.overlays += image('icons/urist/turf/uristturf.dmi', "rock_side_w", layer=6)
	if(!istype(get_step(src, WEST), /turf/simulated/floor/plating/planet/jungle/rock) && !istype(get_step(src, WEST), /turf/unsimulated/wall))
		T = get_step(src, WEST)
		if (T)
			T.overlays += image('icons/urist/turf/uristturf.dmi', "rock_side_e", layer=6)
	. = ..()

/turf/simulated/floor/plating/planet/jungle/rock/weather_enable()
	return

/turf/simulated/floor/plating/planet/jungle/water
	animal_spawn_chance = 0
	bushspawnchance = 0
...
/turf/simulated/floor/plating/planet/jungle/water/Initialize()
	. = ..()
	fishleft = rand(1,6)

/turf/simulated/floor/plating/planet/jungle/water/attackby(var/obj/item/I, mob/user as mob)
...
/turf/simulated/floor/plating/planet/jungle/water/Entered(atom/movable/O)
	..()
...
/turf/simulated/floor/plating/planet/jungle/water/deep
	plants_spawn_chance = 0
	density = 1
...
/turf/simulated/floor/plating/planet/jungle/water/deep/CanPass(atom/movable/mover, turf/target)
	if(istype(mover,/obj/item/projectile))
		return 1

	else ..()

/turf/simulated/floor/plating/planet/jungle/water/deep/attackby(var/obj/item/I, mob/user as mob)
...
/turf/simulated/floor/plating/planet/jungle/temple_wall
	name = "temple wall"
	desc = ""
	density = 1
	icon = 'icons/turf/walls.dmi'
...
/turf/simulated/floor/plating/planet/jungle/water/edge
	name = "murky water"
	desc = "thick, murky water"
	icon = 'icons/urist/jungle/turfs.dmi'
	icon_state = "test"
...
/turf/simulated/floor/plating/planet/jungle/clear/underground
	name = "dirt"
...
/turf/simulated/floor/plating/planet/jungle/clear/underground/weather_enable(var/override = 0)
	if(override)
		..()