...
/datum/file/program
	name					= "Untitled"
	extension				= "prog"
	image					= 'icons/urist/computer3/NTOS/program.png'
...
/datum/file/program/New()
	...
	overlay = image('icons/urist/computer3/computer3.dmi',icon_state = active_state)
...
/datum/file/program/proc/interactable(var/mob/user = usr)
	if(computer && computer.interactable(user))
		if(!popup)
			...
			popup.set_title_buttons(topic_link(src,"quit","<img src=\ref['icons/urist/computer3/NTOS/tb_close.png']>"))
		if(popup.user != user)
			popup.user = user
			popup.set_title_image(usr.browse_rsc_icon(overlay.icon, overlay.icon_state))
...
/datum/file/program/RD
	name = "R&D Manager"
	image = 'icons/urist/computer3/NTOS/research.png'
...
/datum/file/program/RDserv
	name = "R&D Server"
	image = 'icons/urist/computer3/NTOS/server.png'
	active_state = "rdcomp"
	volume = 9000

/datum/file/program/SuitSensors
	name = "Crew Monitoring"
	image = 'icons/urist/computer3/NTOS/monitoring.png'
	active_state = "crew"
	volume = 3400

/datum/file/program/Genetics
	name = "Genetics Suite"
	image = 'icons/urist/computer3/NTOS/genetics.png'
...
/datum/file/program/Cloning
	...
	image = 'icons/urist/computer3/NTOS/cloning.png'
...
/datum/file/program/TCOMmonitor
	name = "TComm Monitor"
	image = 'icons/urist/computer3/NTOS/tcomms.png'
...
/datum/file/program/securitycam
	...
	image = 'icons/urist/computer3/NTOS/camera.png'
	drm = 1
...
/datum/file/program/securityrecords
	...
	image = 'icons/urist/computer3/NTOS/records.png'
	drm = 1
...
/datum/file/program/medicalrecords
	...
	image = 'icons/urist/computer3/NTOS/medical.png'
	drm = 1
...
/datum/file/program/SMSmonitor
	...
	image = 'icons/urist/computer3/NTOS/pda.png'
	active_state = "comm_monitor"
	volume = 3070

/datum/file/program/OperationMonitor
	name = "OR Monitor"
	image = 'icons/urist/computer3/NTOS/operating.png'
...
/datum/file/program/PowerMonitor
	name = "Power Grid"
	image = 'icons/urist/computer3/NTOS/power.png'
	active_state = "power"
	volume = 7200

/datum/file/program/PrisonerManagement
	name = "Prisoner Control"
	image = 'icons/urist/computer3/NTOS/prison.png'
	drm = 1
	active_state = "power"
	volume = 5000
...
/datum/file/program/Roboticscontrol
	name = "Cyborg Maint"
	image = 'icons/urist/computer3/NTOS/borgcontrol.png'
	active_state = "robot"
	volume = 9050

/datum/file/program/AIupload
	name = "AI Upload"
	image = 'icons/urist/computer3/NTOS/aiupload.png'
	active_state = "command"
	volume = 5000

/datum/file/program/Cyborgupload
	name = "Cyborg Upload"
	image = 'icons/urist/computer3/NTOS/borgupload.png'
	active_state = "command"
	volume = 5000

/datum/file/program/Exosuit
	name = "Exosuit Monitor"
	image = 'icons/urist/computer3/NTOS/exocontrol.png'
	active_state = "mecha"
	volume = 7000
...
/datum/file/program/Stationalert
	name = "Alert Monitor"
	image = 'icons/urist/computer3/NTOS/alerts.png'
	active_state = "computer_generic"
	volume = 10150
