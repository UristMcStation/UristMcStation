...
/obj/item/clothing/under/rank/scientist/executive
	name = "white and green polo and pants"
...
/obj/item/clothing/under/rank/ntpilot
	...
	desc = "A sleek green flight suit. It proudly sports three different patches with corporate logos on them, as well as several unnecessary looking flaps and pockets for effect."
	icon_state = "pilot"
	item_state = "g_suit"
	worn_state = "pilot"
	item_icons = list(slot_w_uniform_str = 'icons/mob/onmob/onmob_under_corporate.dmi')
...
/obj/item/clothing/under/suit_jacket/corp
	...
	desc = "A set of black and green suit pants and shirt that particularly enthusiastic company executives tend to wear."
	icon_state = "suit"
	item_state = "bl_suit"
	worn_state = "suit"
