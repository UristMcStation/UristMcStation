...
/material/plasteel/generate_recipes()
	...
	recipes += new/datum/stack_recipe("Scrap metal shield", /obj/item/weapon/shield/riot/scrapper, 10, time = 50, one_per_turf = 0)
...
/material/wood/generate_recipes()
	...
	recipes += new/datum/stack_recipe("bookcase", /obj/structure/bookcase, 7, time = 30, one_per_turf = 1, on_floor = 1)
	recipes += new/datum/stack_recipe("dresser", /obj/structure/dresser, 10, time = 40, one_per_turf = 1, on_floor = 1)
	recipes += new/datum/stack_recipe("wooden cabinet", /obj/structure/closet/cabinet, 5, time = 25, one_per_turf = 1, on_floor = 1)
