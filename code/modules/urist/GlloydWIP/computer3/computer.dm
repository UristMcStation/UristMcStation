/obj/machinery/computer3
	name = "computer"
	icon = 'icons/urist/computer3/computer3.dmi'
	icon_state = "frame"
	density = 1
	anchored = 1.0
	...
	New(var/L, var/built = 0)
		...
		if(show_keyboard)
			...
			kb = image('icons/urist/computer3/computer3.dmi',icon_state=kb_state)
			overlays += kb
	...
	*/
	...
	update_icon()
		...
		if(program)
			...
			var/global/image/generic = image('icons/urist/computer3/computer3.dmi',icon_state="osod") // orange screen of death
