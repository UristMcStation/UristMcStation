...
/obj/machinery/computer/rdconsole/attack_hand(mob/user as mob)
	...
	switch(screen)
		...
		if(3.1)
			...
			dat += "<UL>"
			dat += "<A href='?src=\ref[src];menu=5.1'>Machine Parts Fabrication</A> <BR> "
			dat += "<A href='?src=\ref[src];menu=5.2'>Weapon Design Fabrication</A> <BR>"
			dat += "<A href='?src=\ref[src];menu=5.3'>Bluespace Device Fabrication</A> <BR>"
			dat += "<A href='?src=\ref[src];menu=5.4'>Biomedical Device Fabrication</A> <BR>"
			dat += "<A href='?src=\ref[src];menu=5.5'>Tool Design Fabrication</A> <BR>"
			dat += "<A href='?src=\ref[src];menu=5.6'>General Device Fabrication</A> <BR>"
			dat += "<A href='?src=\ref[src];menu=5.7'>Modular Computer Component Fabrication</A> <BR>"
			dat += "<A href='?src=\ref[src];menu=5.8'>RIG Module Fabrication</A> <BR>"
			dat += "<A href='?src=\ref[src];menu=5.9'>Miscellaneous Fabrication</A> <BR>"
			dat += "</UL>"
		...
		if(4.1)
			...
			dat += "<UL>"
			dat += "<A href='?src=\ref[src];menu=6'>General Circuitry Fabrication</A> <BR> "
			dat += "<A href='?src=\ref[src];menu=6.1'>Exosuit Circuitry Fabrication</A> <BR> "
			dat += "<A href='?src=\ref[src];menu=6.2'>AI Circuitry Fabrication</A> <BR> "
			dat += "<A href='?src=\ref[src];menu=6.3'>Machinery Circuitry Fabrication</A> <BR> "
			dat += "<A href='?src=\ref[src];menu=6.4'>Telecommunication Circuitry Fabrication</A> <BR> "
			dat += "<A href='?src=\ref[src];menu=6.5'>Computer Circuitry Fabrication</A> <BR> "
			dat += "</UL>"
