...
/datum/file/program/NTOS/proc/window(var/title,var/buttonbar,var/content)
	return {"
	<div class='filewin'>
		<div class='titlebar'>[title] <a href='?src=\ref[src];winclose'><img src=\ref['icons/urist/computer3/NTOS/tb_close.png']></a></div>
...
/datum/file/program/NTOS/interact()
	...
	<body><div style='width:640px;height:480px;	border:2px solid black;padding:8px;background-image:url(\ref['icons/urist/computer3/NTOS/ntos.png'])'>"}
