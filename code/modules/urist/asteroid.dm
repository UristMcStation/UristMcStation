//Rooms and whatnot. Also some stuff for the mining tunnels and caves.
...
proc/make_mining_asteroid_secret()
	...
	switch(pick(possiblethemes))//what kind of room is this gonna be?
		if("organharvest")
			...
			fluffitems = list(/obj/effect/decal/cleanable/blood=5,/obj/item/weapon/reagent_containers/food/snacks/appendix=2,/obj/structure/closet/crate/freezer=2,
		...
		if("cult")
			...
			treasureitems = list(/mob/living/simple_animal/hostile/creature=1,/obj/item/device/soulstone=1)
		...
		if("wizden")
			...
			fluffitems = list(/obj/structure/safe/floor=1,/obj/item/weapon/storage/belt/soulstone=1,/obj/item/trash/candle=3,
		...
		if("plantlab")
			theme = "plantlab"
			treasureitems = list(/obj/item/weapon/gun/energy/floragun=1,/obj/item/seeds/bluespacetomatoseed=2)
			fluffitems = list(/obj/structure/flora/pottedplant=1,/obj/structure/table/reinforced=2,/obj/machinery/hydroponics=1,
