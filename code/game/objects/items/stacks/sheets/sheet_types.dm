...
var/global/list/datum/stack_recipe/metal_recipes = list ( \
	...
	new/datum/stack_recipe("bed", /obj/structure/bed/nice, 2, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("wheelchair", /obj/structure/bed/chair/wheelchair, 10, one_per_turf = 1, on_floor = 1), \
	null, \
	...
	new/datum/stack_recipe("metal baseball bat", /obj/item/weapon/twohanded/baseballbat/metal, 10, time = 20, one_per_turf = 0, on_floor = 0), \
